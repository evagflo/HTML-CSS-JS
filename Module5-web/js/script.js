...
//remove the class 'active' from home an switch to menu button
...
// using categories dat and snippets html
// build categoriesv iew html to be inserted into page
...
// ad clearfix after every second menu tiem
if (i % 2 != 0) {
  html +=
...
// appends prics with '$' if price exists
function insertItemPrice (html, pricePropName, priceValue){
  // if not specicidie, replace with empty string
  if (!priceValue){
