...
function buildAndShowHomeHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(
    ...
    function (homeHtml) {
      ...
      var chosenCategoryShortName = chooseRandomCategory(categories);//passa totes les categories i retorna una categoria random
      console.log(chosenCategoryShortName.short_name);
      var chosenCategoryToPass= "'" + chosenCategoryShortName.short_name + "'";
      console.log(chosenCategoryToPass);
      var homeSnippet = homeHtml;
      var homeHtmlToInsertIntoMainPage =insertProperty(homeHtml,
                                        "randomCategoryShortName",
                                        chosenCategoryToPass);
